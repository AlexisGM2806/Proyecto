...
namespace LibraryTests
{
    public class ControladorTests
    {
        ...
        public void AñadirUsuario_AñadeUsuario_Test()
        {
            ...
            int resultado = Controlador.GetUsuarios().Count(u => u.Equals(nuevoUsuario));
        ...
        public void AñadirItem_AñadeItem_Test()
        {
            ...
            int resultado = Controlador.GetItems().Count(u => u.Equals(nuevoItem));
        ...
        public void AñadirInteraccion_AñadeInteraccion_Test()
        {
            ...
            int resultado = Controlador.GetInteracciones().Count(u => u.Equals(nuevaInteraccion));
        ...
        public void RankingPorInteracciones_Test()
        {
            ...
            List<IItem> resultado = Controlador.RankingPorInteracciones();
        ...
        public void RankingPorPreferencias_Correcto_Test()
        {
            ...
            Usuario usuario = Controlador.GetUsuario("Prueba1");

            List<IItem> resultado = Controlador.RankingPorPreferencia(usuario);
        ...
        {
            Usuario usuario = Controlador.GetUsuario("Usuario1");
        ...
        public void GetUsuario_Correcto_Test()
        {
            ...
            Usuario resultado = Controlador.GetUsuario("Prueba1");
        ...
        {;
            Usuario resultado = Controlador.GetUsuario("Usuario1");
        ...
        public void GetItem_Correcto_Test()
        {
            ...
            IItem resultado = Controlador.GetItem("Musica1");
        ...
        {;
            IItem resultado = Controlador.GetItem("Musica100");
        ...
        public void GetInteraccion_Correcto_Test()
        {
            ...
            Interaccion resultado = Controlador.GetInteraccion(usuario, item);
        ...
        {
            List<Usuario> resultado = Controlador.GetUsuarios();
        ...
        {
            List<IItem> resultado = Controlador.GetItems();
        ...
        {
            List<Interaccion> resultado = Controlador.GetInteracciones();
